...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const games = [
    ...
    },
    {
      name: "Minesweeper",
      icon: "💣",
      key: "minesweeper_highscore",
      type: "Best Time",
    },
    {
      name: "Whack-a-Mole",
      icon: "🔨",
      key: "whackamole_highscore",
      type: "Score",
    },
    ...
    { name: "Wordle", icon: "📝", key: "wordle_highscore", type: "Wins" },
    {
      name: "4 Pics 1 Word",
      icon: "🖼️",
      key: "picsword_highscore",
      type: "Score",
    },
    {
      name: "Sliding Puzzle",
      icon: "🧩",
      key: "sliding_highscore",
      type: "Best Time",
    },
    {
      name: "Bubble Shooter",
      icon: "🎯",
      key: "bubble_highscore",
      type: "Score",
    },
